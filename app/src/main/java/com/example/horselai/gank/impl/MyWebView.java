...
/**
 * Created by horseLai on 2017/8/13.
 */
...
public class MyWebView extends WebView implements NestedScrollingChild
{
    ...
    // TODO: 2017/8/14 解决滑动是CollapseScrollLayout收缩偏移量过大的问题
    ...
    @Override protected void onScrollChanged(int l, int t, int oldl, int oldt)
    {
        ...
        if (mScrollChangeListener != null) {
            mScrollChangeListener.onScrollChange(l - oldl, t - oldt);
        }
    }

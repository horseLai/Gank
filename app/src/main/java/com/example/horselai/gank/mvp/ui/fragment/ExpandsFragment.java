...
public class ExpandsFragment extends CommGankNewsListFragment
{
    private static final String TAG = "ExpandsFragment";


    @Override protected void doUpdateDataList()
    {
        updateData(GankUI.PAGE_EXPANDS, ITEM_SIZE, ++mPageNum);
    }
